    ...
    public function handle(): void
    {
        ...
        foreach ($companyRows as $company) {
            ...
            foreach ($accumulators as $weekly) {
                ...
                // Call volume is capped at fetch time by the company's monthly call limit,
                // so report generation no longer gates on a minutes balance. minutes_consumed
                // is retained purely as an informational metric on the report.
